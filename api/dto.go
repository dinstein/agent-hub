...
// Health level constants (docs/subsystems/controlplane.md). Frozen wire values: frontends
...
// AdminState constants (docs/subsystems/controlplane.md). A disabled server
...
// Action constants (docs/subsystems/controlplane.md): the machine-readable suggested action
...
// Hello is the daemon's answer to Ping (docs/subsystems/controlplane.md): version for
...
// function (docs/subsystems/controlplane.md). A frontend presenting this DTO
