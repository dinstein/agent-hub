...
// ---------------------------------------------------------------------------
// The curated catalog (api/catalog.go, docs/subsystems/controlplane.md)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Pasted client configuration (api/catalog.go, docs/subsystems/controlplane.md)
// ---------------------------------------------------------------------------
...
export const ErrCode = {
   ...
   *  refusal is permanent by design (docs/subsystems/controlplane.md). */
