...
// Ingress hard bounds (docs/subsystems/controlplane.md; the numbers are inherited
...
// (docs/subsystems/controlplane.md, "The 404 text is unified and frozen byte for
