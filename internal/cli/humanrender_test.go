...
func TestEveryHumanRendererHandlesTheZeroValue(t *testing.T) {
	cases := []struct {
		...
		{ApprovalDecideResult{}, "ApprovalDecideResult"},
		...
		{SessionScopeResult{}, "SessionScopeResult"},
		...
		{ToolList{}, "ToolList"},
		{ToolOverrideRow{}, "ToolOverrideRow"},
		{ToolStateRow{}, "ToolStateRow"},
	}
