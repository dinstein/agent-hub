...
// The curated catalog on the wire (docs/subsystems/controlplane.md): GET /v1/catalog[?q=],
...
// judgement (docs/subsystems/controlplane.md "skip whatever can be skipped") that every frontend must make identically:
...
type catalogAddResult struct {
	...
	// showing the equivalent command IS the GUI's teaching surface (docs/subsystems/controlplane.md).
