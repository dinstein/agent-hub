...
//
// .agents/skills/release/SKILL.md opens by saying the VERSION file is the one
// source and that changing it in one place makes three places agree. That is true of the
